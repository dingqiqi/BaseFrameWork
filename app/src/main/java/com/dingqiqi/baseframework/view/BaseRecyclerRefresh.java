...
import com.dingqiqi.baseframework.adapter.BaseAdapter;
...
public class BaseRecyclerRefresh extends FrameLayout implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void addFooterView() {
        if (mRecyclerView.getAdapter() != null && mRecyclerView.getAdapter() instanceof BaseAdapter) {
            if (!mIsAddFooterView) {
                ((BaseAdapter) mRecyclerView.getAdapter()).addFooterView(mFooterView);
    ...
    public void stopLoadMore() {
        ((BaseAdapter) mRecyclerView.getAdapter()).loadMore(false);
        mStatus = Status.NONE;
    }
