...
public class LogUtil {
     ...
     */
    public static void init(Context context, boolean isTime) {
        String fileName = null;
        try {
            if (isTime) {
                fileName = FileUtil.getDefaultPath(context, LOG_PATH) + "/logs_" + TimeUtil.mDateFormat.format(new Date(System.currentTimeMillis())) + ".txt";
            } else {
                fileName = FileUtil.getDefaultPath(context, LOG_PATH) + "/logs_project.txt";
